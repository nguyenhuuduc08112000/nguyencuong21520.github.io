  ...
  async showScreen(screenName) {
    ...
    switch(screenName) {
      ...
      case 'chat': {
        ...
        // TODO: catch form-add-conversation.onsubmit
        // get data: { title, friendEmail }
        // newConversation: { title, createdAt, users: [currentEmail, friendEmail], messages: [] }
        // add newConversation to collection 'conversations'
      }
    }
  },
